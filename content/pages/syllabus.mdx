...
| **A**    | **A-**  | **B+**  | **B**   | **B-**  | **C+**  | **C**   | **C-**  | **D**   | **F**  |
| -------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------ |
| [100     | (95     | (90     | (86.66  | (83.33  | (80 -   | (76.66  | (73.33  | (70     | (60    |
|  - 95]   | - 90]   | - 86.66]| - 83.33]| - 80]   | - 76.66]| - 73.33 | - 70]   | - 60]   | - 0]   |

_ Grades are calculated to the nearest hundreth and not otherwise rounded for mapping to letter grades. For example, a course grade of 89.99 is mapped to a B+_
...
- **Midterm 01**: 9/14/2026
- **Midterm 02**: 10/28/2026
